...
func Filter[T any](collection []T, predicate func(x T) bool, exclude bool) []T {
    var result []T
...
func Keep[T any](collection []T, predicate func(x T) bool) []T {
...
func Discard[T any](collection []T, predicate func(x T) bool) []T {
