...
export function isEachCardEven(stack) {
  return stack.every(stackCard => stackCard % 2 === 0);
}
...
export function doesStackIncludeOddCard(stack) {
  return stack.some(stackCard => stackCard % 2 !== 0);
}
...
export function getFirstOddCard(stack) {
  return stack.find(stackCard => stackCard % 2 !== 0);
}
...
export function getFirstEvenCardPosition(stack) {
  return stack.findIndex(stackCard => stackCard % 2 === 0);
}
